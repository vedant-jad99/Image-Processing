...
class Edge_Detector_mean_filter:
    ...
    def edge_detect(self):
        ...
        img_save_name = 'edge_det_mean_filter' + m + ".jpg"
...
if __name__ == "__main__":    
    img = Edge_Detector_mean_filter("/home/thedarkcoder/Desktop/Computer science/Programs/Python programs/files_for_progs/image.jpg")
    
    img.show_image(1)

    kernel = np.ones((5,5))
    img.mean_filter(kernel)
    img.edge_detect()
    img.show_image()